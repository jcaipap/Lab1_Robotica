...
*Insertar imagen herramienta puesta*
...
![Imagen inicial T1](https://github.com/jcaipap/Lab1_Robotica_Caipa_Holguin/blob/main/Videos/imagenes/AJA.png?raw=true)
...
Finalmente, al comprobar que todo el programa se corre sin presentar errores, ya está listo para exportarse y ser implementado. Para ello se va a Controlador, y en el árbol de procesos RAPID>T_ROB1, se da Clic Derecho>Guardar programa cómo, lo cual generará una carpeta en el computador que almacena el código que se utiliza en el Robot, específicamente en el FlexPendant. *Foto carpeta*
